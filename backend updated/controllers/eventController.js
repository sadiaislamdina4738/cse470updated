...
const createEvent = async (req, res) => {
  try {
    ...
    const { title, description, category, location, coordinates, schedule, banner, maxAttendees, requiresApproval, paymentLink } = req.body;
...
const updateEvent = async (req, res) => {
  try {
    ...
    const allowed = ['title', 'description', 'category', 'location', 'coordinates', 'schedule', 'banner', 'maxAttendees', 'requiresApproval', 'isActive', 'paymentLink'];
    allowed.forEach((key) => {
